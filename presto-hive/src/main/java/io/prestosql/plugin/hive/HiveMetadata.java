...
import static io.prestosql.plugin.hive.ViewReader.decodeView;
import static io.prestosql.plugin.hive.ViewReader.encodeViewData;
import static io.prestosql.plugin.hive.ViewReader.isHiveOrPrestoView;
import static io.prestosql.plugin.hive.ViewReader.isPrestoView;
        ...
        implements TransactionalMetadata
{
    ...
    public Optional<ConnectorViewDefinition> getView(ConnectorSession session, SchemaTableName viewName)
    {
        ...
        return metastore.getTable(new HiveIdentity(session), viewName.getSchemaName(), viewName.getTableName())
                .filter(ViewReader::canDecodeView)
                .map(view -> {
                    ConnectorViewDefinition definition = decodeView(metastore, new HiveIdentity(session), view, catalogName, typeManager);
